...
- **PostgreSQL 18**: `create_foreignscan_path()` signature changed - `baserel->lateral_relids` replaced with `required_outer` parameter
- **PostgreSQL 17**: Added `fdw_restrictinfo` and `fdw_private` parameters to `create_foreignscan_path()`
